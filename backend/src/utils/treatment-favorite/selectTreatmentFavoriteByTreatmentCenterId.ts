...
export async function selectTreatmentFavoriteByTreatmentCenterId(treatmentFavorite: TreatmentFavorite) {
    try {
        ...
        const mySqlSelectQuery = 'SELECT BIN_TO_UUID(treatmentFavoriteTreatmentCenterId) as treatmentFavoriteTreatmentCenterId FROM treatmentFavorite WHERE treatmentFavoriteTreatmentCenterId = UUID_TO_BIN(:treatmentFavoriteTreatmentCenterId)'
